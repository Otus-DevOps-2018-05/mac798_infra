...
# ДЗ 11 (ansible-4)
## Основное задание
* Выполнены задания со слайдов 1-48
## Задание со * [1]
* в vagrantfile добавлена переменная nginx_sites для appserver, содержимое аналогично содержимому из прощлого ДЗ
## Второе задание
* Сделаны манипуляции по слайдам 50-61
* использован модуль Socket для теста, проверяющего, что сервер БД слушает соединения на порт 27017
* В шаблоны packer app.json и db.json добавлены переменные ansible_env_vars с указанием ANSIBLE_ROLES_PATH, чтобы использовать роли в сценариях ansible.
## Задание со * [2] (не сделано)
* роль db перенесена в отдельный репозиторий git@github.com:mac798/db-role.git
* интеграция с travis-ci не доделана
